const addresses = require("../addresses/projectTwoAbi");
...
const getProjectTwoData = async (web3s) => {
  ...
  let projectTwo = new bsc_web3.eth.Contract(
    projectTwoAbi,
    projectTwo_addresses.contract
  );
  ...
  // Get base values
  tokenData.bsc.totalSupply.value = await projectTwo.methods
    .totalSupply()
    .call();
  ...
  tokenData.bsc.circulatingSupply.value =
    tokenData.bsc.totalSupply.value - team_tokens;

  // Set up descriptions
  tokenData.bsc.totalSupply.description =
    "Total supply of Greenheart projectTwo on BSC";

  tokenData.bsc.circulatingSupply.description =
    "Circulating supply of Greenheart projectTwo on BSC";
